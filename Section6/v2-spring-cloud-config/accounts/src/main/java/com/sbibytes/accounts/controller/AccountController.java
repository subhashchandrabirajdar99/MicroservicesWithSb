...
@Tag(
        name = "CRUD REST APIs for Accounts in SBIBank",
...
public class AccountController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer & Account inside SBIBank"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            ...
            description = "REST API to fetch Customers & Account details based on a mobile number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
