package com.sbibytes.loans.controller;
...
import com.sbibytes.loans.dto.ResponseDto;
import com.sbibytes.loans.service.ILoansService;
...
@Tag(
        name = "CRUD REST APIs for Loans in sbbyteBank",
        description = "CRUD REST APIs in SbiBank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside SbiBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
